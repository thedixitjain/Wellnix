# 🏗️ Wellnix Project Restructuring Plan
...
### Root Level
```
heltin/app.py                    → gateway/app.py
heltin/__init__.py               → gateway/__init__.py
heltin/requirements.txt          → gateway/requirements.txt
```

### Nutri AI
```
health_o_meter/                  → services/nutri-ai-service/
health_o_meter/app.py           → services/nutri-ai-service/api/routes.py
health_o_meter/ocr/             → services/nutri-ai-service/core/ocr/
health_o_meter/scoring/         → services/nutri-ai-service/core/scoring/
health_o_meter/retrieval/       → services/nutri-ai-service/core/retrieval/
health_o_meter/user_profile/    → services/nutri-ai-service/core/profile/
health_o_meter/data/            → data/nutri-ai/
health_o_meter/templates/       → web/templates/nutri-ai/
health_o_meter/static/          → web/static/ (merge)
```
